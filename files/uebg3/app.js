...
app.post('/users', function(req,res,next) {
    var id = store.insert('users', req.body); // TODO check that the element is really a tweet!
    // set code 201 "created" and send the item back
...
app.post('/retweets', function(req,res,next) {
    var id = store.insert('retweets', req.body); // TODO check that the element is really a tweet!
    // set code 201 "created" and send the item back
